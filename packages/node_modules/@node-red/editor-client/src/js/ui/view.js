...
RED.view = (function () {
    ...
    function createIconAttributes(iconUrl, icon_group, d) {
        ...
        console.log(d.type)
        var key = d.type.replaceAll(' ', '');

        if (RED.settings.editorTheme.palette.nodes && RED.settings.editorTheme.palette.nodes[d.type]) {
            iconUrl = RED.settings.editorTheme.palette.nodes[key].iconUrl;
        }
